...
namespace SolutionDriver {
	...
	void SteadyStateDriver::Initialize(RayTracingDomain &Rays, FluxBoundary &BndFlux, FlatSrcDomain &FSR, FlatXSDomain &FXR, DriverSCMOC &MOCDriver) {
		this->Rays = &Rays; this->BndFlux = &BndFlux;
		this->FSR = &FSR; this->FXR = &FXR;
		this->MOCDriver = &MOCDriver;
